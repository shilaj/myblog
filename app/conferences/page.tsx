...
export const metadata = { title: 'Conferences & Talks' };

export default function ConferencesPage() {
  const { frontmatter, content } = getMarkdownContent('conferences.md');
  ...
  return (
    <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:py-16">
      <div className="mb-8 space-y-2">
        ...
        <h1 className="text-3xl font-semibold text-white sm:text-4xl">{frontmatter.title || 'Conferences & Talks'}</h1>
      </div>
